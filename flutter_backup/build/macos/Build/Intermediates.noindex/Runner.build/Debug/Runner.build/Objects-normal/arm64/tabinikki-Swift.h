...
#ifndef TABINIKKI_SWIFT_H
#define TABINIKKI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tabinikki",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9tabinikki11AppDelegate")
...
SWIFT_CLASS("_TtC9tabinikki17MainFlutterWindow")
